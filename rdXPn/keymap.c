...
// Shift + esc = ~
const key_override_t tilde_esc_override = ko_make_basic(MOD_MASK_GUI, LT(2, KC_ESCAPE), S(KC_GRV));

// GUI + esc = `
const key_override_t grave_esc_override = ko_make_basic(MOD_MASK_GUI, LT(2, KC_ESCAPE), KC_GRV);
